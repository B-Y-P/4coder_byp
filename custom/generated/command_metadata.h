...
#define command_one_past_last_id 322
...
static Command_Metadata fcoder_metacmd_table[322] = {
...
{ PROC_LINKS(byp_auto_complete_bracket, 0), false, "byp_auto_complete_bracket", 25, "Sets the right size of the view near the x position of the cursor.", 66, "P:\\4coder\\4coder_byp\\4coder_byp_commands.cpp", 44, 110 },
...
{ PROC_LINKS(byp_find_divider_down, 0), false, "byp_find_divider_down", 21, "Find //- divider below cursor", 29, "P:\\4coder\\4coder_byp\\4coder_byp_commands.cpp", 44, 193 },
{ PROC_LINKS(byp_find_divider_up, 0), false, "byp_find_divider_up", 19, "Find //- divider above cursor", 29, "P:\\4coder\\4coder_byp\\4coder_byp_commands.cpp", 44, 187 },
{ PROC_LINKS(byp_list_all_locations_selection, 0), false, "byp_list_all_locations_selection", 32, "Lists locations of selection range", 34, "P:\\4coder\\4coder_byp\\4coder_byp_commands.cpp", 44, 219 },
{ PROC_LINKS(byp_open_current_peek, 0), false, "byp_open_current_peek", 21, "Sets the active view to the current peeked buffer", 49, "P:\\4coder\\4coder_byp\\4coder_byp_commands.cpp", 44, 233 },
...
{ PROC_LINKS(byp_reopen_all_buffers, 0), false, "byp_reopen_all_buffers", 22, "Reload current buffer", 21, "P:\\4coder\\4coder_byp\\4coder_byp_commands.cpp", 44, 34 },
{ PROC_LINKS(byp_reset_face_size, 0), false, "byp_reset_face_size", 19, "Resets face size to default", 27, "P:\\4coder\\4coder_byp\\4coder_byp_commands.cpp", 44, 46 },
...
{ PROC_LINKS(byp_write_text_input, 0), false, "byp_write_text_input", 20, "Inserts whatever text was used to trigger this command.", 55, "P:\\4coder\\4coder_byp\\4coder_byp_commands.cpp", 44, 101 },
...
{ PROC_LINKS(explorer, 0), false, "explorer", 8, "Opens file explorer in hot directory", 36, "P:\\4coder\\4coder_byp\\4coder_byp_commands.cpp", 44, 200 },
...
static i32 fcoder_metacmd_ID_byp_reopen_all_buffers = 18;
static i32 fcoder_metacmd_ID_byp_reset_face_size = 19;
static i32 fcoder_metacmd_ID_byp_space = 20;
static i32 fcoder_metacmd_ID_byp_startup = 21;
static i32 fcoder_metacmd_ID_byp_test = 22;
static i32 fcoder_metacmd_ID_byp_theme_lister = 23;
static i32 fcoder_metacmd_ID_byp_toggle_drop_shadow = 24;
...
static i32 fcoder_metacmd_ID_fold_clear = 74;
static i32 fcoder_metacmd_ID_fold_pop_cursor = 75;
static i32 fcoder_metacmd_ID_fold_range = 76;
static i32 fcoder_metacmd_ID_fold_toggle_cursor = 77;
static i32 fcoder_metacmd_ID_go_to_user_directory = 78;
static i32 fcoder_metacmd_ID_goto_beginning_of_file = 79;
static i32 fcoder_metacmd_ID_goto_end_of_file = 80;
static i32 fcoder_metacmd_ID_goto_first_jump = 81;
static i32 fcoder_metacmd_ID_goto_first_jump_same_panel_sticky = 82;
static i32 fcoder_metacmd_ID_goto_jump_at_cursor = 83;
static i32 fcoder_metacmd_ID_goto_jump_at_cursor_same_panel = 84;
static i32 fcoder_metacmd_ID_goto_line = 85;
static i32 fcoder_metacmd_ID_goto_next_jump = 86;
static i32 fcoder_metacmd_ID_goto_next_jump_no_skips = 87;
static i32 fcoder_metacmd_ID_goto_prev_jump = 88;
static i32 fcoder_metacmd_ID_goto_prev_jump_no_skips = 89;
static i32 fcoder_metacmd_ID_hide_filebar = 90;
static i32 fcoder_metacmd_ID_hide_scrollbar = 91;
static i32 fcoder_metacmd_ID_hit_sfx = 92;
static i32 fcoder_metacmd_ID_hms_demo_tutorial = 93;
static i32 fcoder_metacmd_ID_if0_off = 94;
static i32 fcoder_metacmd_ID_if_read_only_goto_position = 95;
static i32 fcoder_metacmd_ID_if_read_only_goto_position_same_panel = 96;
static i32 fcoder_metacmd_ID_increase_face_size = 97;
static i32 fcoder_metacmd_ID_interactive_kill_buffer = 98;
static i32 fcoder_metacmd_ID_interactive_new = 99;
static i32 fcoder_metacmd_ID_interactive_open = 100;
static i32 fcoder_metacmd_ID_interactive_open_or_new = 101;
static i32 fcoder_metacmd_ID_interactive_switch_buffer = 102;
static i32 fcoder_metacmd_ID_jump_to_definition = 103;
static i32 fcoder_metacmd_ID_jump_to_definition_at_cursor = 104;
static i32 fcoder_metacmd_ID_jump_to_last_point = 105;
static i32 fcoder_metacmd_ID_jumps = 106;
static i32 fcoder_metacmd_ID_keyboard_macro_finish_recording = 107;
static i32 fcoder_metacmd_ID_keyboard_macro_replay = 108;
static i32 fcoder_metacmd_ID_keyboard_macro_start_recording = 109;
static i32 fcoder_metacmd_ID_kill_buffer = 110;
static i32 fcoder_metacmd_ID_kill_tutorial = 111;
static i32 fcoder_metacmd_ID_left_adjust_view = 112;
static i32 fcoder_metacmd_ID_list_all_functions_all_buffers = 113;
static i32 fcoder_metacmd_ID_list_all_functions_all_buffers_lister = 114;
static i32 fcoder_metacmd_ID_list_all_functions_current_buffer = 115;
static i32 fcoder_metacmd_ID_list_all_functions_current_buffer_lister = 116;
static i32 fcoder_metacmd_ID_list_all_locations = 117;
static i32 fcoder_metacmd_ID_list_all_locations_case_insensitive = 118;
static i32 fcoder_metacmd_ID_list_all_locations_of_identifier = 119;
static i32 fcoder_metacmd_ID_list_all_locations_of_identifier_case_insensitive = 120;
static i32 fcoder_metacmd_ID_list_all_locations_of_selection = 121;
static i32 fcoder_metacmd_ID_list_all_locations_of_selection_case_insensitive = 122;
static i32 fcoder_metacmd_ID_list_all_locations_of_type_definition = 123;
static i32 fcoder_metacmd_ID_list_all_locations_of_type_definition_of_identifier = 124;
static i32 fcoder_metacmd_ID_list_all_substring_locations = 125;
static i32 fcoder_metacmd_ID_list_all_substring_locations_case_insensitive = 126;
static i32 fcoder_metacmd_ID_load_project = 127;
static i32 fcoder_metacmd_ID_load_theme_current_buffer = 128;
static i32 fcoder_metacmd_ID_load_themes_default_folder = 129;
static i32 fcoder_metacmd_ID_load_themes_hot_directory = 130;
static i32 fcoder_metacmd_ID_make_directory_query = 131;
static i32 fcoder_metacmd_ID_miblo_decrement_basic = 132;
static i32 fcoder_metacmd_ID_miblo_decrement_time_stamp = 133;
static i32 fcoder_metacmd_ID_miblo_decrement_time_stamp_minute = 134;
static i32 fcoder_metacmd_ID_miblo_increment_basic = 135;
static i32 fcoder_metacmd_ID_miblo_increment_time_stamp = 136;
static i32 fcoder_metacmd_ID_miblo_increment_time_stamp_minute = 137;
...
static i32 fcoder_metacmd_ID_theme_lister = 271;
static i32 fcoder_metacmd_ID_to_lowercase = 272;
static i32 fcoder_metacmd_ID_to_uppercase = 273;
static i32 fcoder_metacmd_ID_toggle_filebar = 274;
static i32 fcoder_metacmd_ID_toggle_fps_meter = 275;
static i32 fcoder_metacmd_ID_toggle_fullscreen = 276;
static i32 fcoder_metacmd_ID_toggle_highlight_enclosing_scopes = 277;
static i32 fcoder_metacmd_ID_toggle_highlight_line_at_cursor = 278;
static i32 fcoder_metacmd_ID_toggle_line_numbers = 279;
static i32 fcoder_metacmd_ID_toggle_line_wrap = 280;
static i32 fcoder_metacmd_ID_toggle_mouse = 281;
static i32 fcoder_metacmd_ID_toggle_paren_matching_helper = 282;
static i32 fcoder_metacmd_ID_toggle_show_whitespace = 283;
static i32 fcoder_metacmd_ID_toggle_virtual_whitespace = 284;
