...
{ PROC_LINKS(byp_auto_complete_bracket, 0), false, "byp_auto_complete_bracket", 25, "Sets the right size of the view near the x position of the cursor.", 66, "P:\\4coder\\4coder_byp\\4coder_byp_commands.cpp", 44, 123 },
...
{ PROC_LINKS(byp_find_divider_down, 0), false, "byp_find_divider_down", 21, "Find //- divider below cursor", 29, "P:\\4coder\\4coder_byp\\4coder_byp_commands.cpp", 44, 211 },
{ PROC_LINKS(byp_find_divider_up, 0), false, "byp_find_divider_up", 19, "Find //- divider above cursor", 29, "P:\\4coder\\4coder_byp\\4coder_byp_commands.cpp", 44, 205 },
{ PROC_LINKS(byp_list_all_locations_selection, 0), false, "byp_list_all_locations_selection", 32, "Lists locations of selection range", 34, "P:\\4coder\\4coder_byp\\4coder_byp_commands.cpp", 44, 237 },
{ PROC_LINKS(byp_open_current_peek, 0), false, "byp_open_current_peek", 21, "Sets the active view to the current peeked buffer", 49, "P:\\4coder\\4coder_byp\\4coder_byp_commands.cpp", 44, 251 },
...
{ PROC_LINKS(byp_reload_config, 0), false, "byp_reload_config", 17, "Reloads config.4coder file", 26, "P:\\4coder\\4coder_byp\\4coder_byp_commands.cpp", 44, 34 },
{ PROC_LINKS(byp_reopen_all_buffers, 0), false, "byp_reopen_all_buffers", 22, "Reload current buffer", 21, "P:\\4coder\\4coder_byp\\4coder_byp_commands.cpp", 44, 44 },
{ PROC_LINKS(byp_reset_face_size, 0), false, "byp_reset_face_size", 19, "Resets face size to default", 27, "P:\\4coder\\4coder_byp\\4coder_byp_commands.cpp", 44, 59 },
{ PROC_LINKS(byp_space, 0), false, "byp_space", 9, "When column ruler is set, spaces towards that, else just inserts one space", 74, "P:\\4coder\\4coder_byp\\4coder_byp_commands.cpp", 44, 88 },
...
{ PROC_LINKS(byp_toggle_set_col_ruler, 0), false, "byp_toggle_set_col_ruler", 24, "Toggles the column ruler. Set to cursor column when on.", 55, "P:\\4coder\\4coder_byp\\4coder_byp_commands.cpp", 44, 74 },
...
{ PROC_LINKS(byp_write_text_input, 0), false, "byp_write_text_input", 20, "Inserts whatever text was used to trigger this command.", 55, "P:\\4coder\\4coder_byp\\4coder_byp_commands.cpp", 44, 114 },
...
{ PROC_LINKS(explorer, 0), false, "explorer", 8, "Opens file explorer in hot directory", 36, "P:\\4coder\\4coder_byp\\4coder_byp_commands.cpp", 44, 218 },
...
static i32 fcoder_metacmd_ID_byp_space = 21;
static i32 fcoder_metacmd_ID_byp_startup = 22;
static i32 fcoder_metacmd_ID_byp_test = 23;
static i32 fcoder_metacmd_ID_byp_theme_lister = 24;
static i32 fcoder_metacmd_ID_byp_toggle_drop_shadow = 25;
...
static i32 fcoder_metacmd_ID_go_to_user_directory = 79;
static i32 fcoder_metacmd_ID_goto_beginning_of_file = 80;
static i32 fcoder_metacmd_ID_goto_end_of_file = 81;
static i32 fcoder_metacmd_ID_goto_first_jump = 82;
static i32 fcoder_metacmd_ID_goto_first_jump_same_panel_sticky = 83;
static i32 fcoder_metacmd_ID_goto_jump_at_cursor = 84;
static i32 fcoder_metacmd_ID_goto_jump_at_cursor_same_panel = 85;
static i32 fcoder_metacmd_ID_goto_line = 86;
static i32 fcoder_metacmd_ID_goto_next_jump = 87;
static i32 fcoder_metacmd_ID_goto_next_jump_no_skips = 88;
static i32 fcoder_metacmd_ID_goto_prev_jump = 89;
static i32 fcoder_metacmd_ID_goto_prev_jump_no_skips = 90;
static i32 fcoder_metacmd_ID_hide_filebar = 91;
static i32 fcoder_metacmd_ID_hide_scrollbar = 92;
static i32 fcoder_metacmd_ID_hit_sfx = 93;
