...
{ PROC_LINKS(byp_auto_complete_bracket, 0), false, "byp_auto_complete_bracket", 25, "Sets the right size of the view near the x position of the cursor.", 66, "P:\\4coder\\4coder_byp\\4coder_byp_commands.cpp", 44, 147 },
...
{ PROC_LINKS(byp_find_divider_down, 0), false, "byp_find_divider_down", 21, "Find //- divider below cursor", 29, "P:\\4coder\\4coder_byp\\4coder_byp_commands.cpp", 44, 235 },
{ PROC_LINKS(byp_find_divider_up, 0), false, "byp_find_divider_up", 19, "Find //- divider above cursor", 29, "P:\\4coder\\4coder_byp\\4coder_byp_commands.cpp", 44, 229 },
{ PROC_LINKS(byp_list_all_locations_selection, 0), false, "byp_list_all_locations_selection", 32, "Lists locations of selection range", 34, "P:\\4coder\\4coder_byp\\4coder_byp_commands.cpp", 44, 261 },
{ PROC_LINKS(byp_open_current_peek, 0), false, "byp_open_current_peek", 21, "Sets the active view to the current peeked buffer", 49, "P:\\4coder\\4coder_byp\\4coder_byp_commands.cpp", 44, 275 },
...
{ PROC_LINKS(byp_reload_config, 0), false, "byp_reload_config", 17, "Reloads config.4coder file", 26, "P:\\4coder\\4coder_byp\\4coder_byp_commands.cpp", 44, 58 },
...
{ PROC_LINKS(byp_reset_face_size, 0), false, "byp_reset_face_size", 19, "Resets face size to default", 27, "P:\\4coder\\4coder_byp\\4coder_byp_commands.cpp", 44, 83 },
{ PROC_LINKS(byp_search_token, 0), false, "byp_search_token", 16, "select token or alpha-num range", 31, "P:\\4coder\\4coder_byp\\4coder_byp_commands.cpp", 44, 45 },
{ PROC_LINKS(byp_space, 0), false, "byp_space", 9, "When column ruler is set, spaces towards that, else just inserts one space", 74, "P:\\4coder\\4coder_byp\\4coder_byp_commands.cpp", 44, 112 },
...
{ PROC_LINKS(byp_toggle_set_col_ruler, 0), false, "byp_toggle_set_col_ruler", 24, "Toggles the column ruler. Set to cursor column when on.", 55, "P:\\4coder\\4coder_byp\\4coder_byp_commands.cpp", 44, 98 },
...
{ PROC_LINKS(byp_write_text_input, 0), false, "byp_write_text_input", 20, "Inserts whatever text was used to trigger this command.", 55, "P:\\4coder\\4coder_byp\\4coder_byp_commands.cpp", 44, 138 },
...
{ PROC_LINKS(explorer, 0), false, "explorer", 8, "Opens file explorer in hot directory", 36, "P:\\4coder\\4coder_byp\\4coder_byp_commands.cpp", 44, 242 },
...
static i32 fcoder_metacmd_ID_byp_find_divider_down = 13;
static i32 fcoder_metacmd_ID_byp_find_divider_up = 14;
static i32 fcoder_metacmd_ID_byp_list_all_locations_selection = 15;
static i32 fcoder_metacmd_ID_byp_open_current_peek = 16;
static i32 fcoder_metacmd_ID_byp_project_fkey_command = 17;
static i32 fcoder_metacmd_ID_byp_reload_config = 18;
static i32 fcoder_metacmd_ID_byp_reopen_all_buffers = 19;
static i32 fcoder_metacmd_ID_byp_reset_face_size = 20;
static i32 fcoder_metacmd_ID_byp_search_token = 21;
