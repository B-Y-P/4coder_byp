...
static Command_Metadata fcoder_metacmd_table[326] = {
	...
	{ PROC_LINKS(byp_auto_complete_bracket, 0), false, "byp_auto_complete_bracket", 25, "Sets the right size of the view near the x position of the cursor.", 66, "P:\\4coder\\4coder_byp\\4coder_byp_commands.cpp", 44, 175 },
	...
	{ PROC_LINKS(byp_close_all_buffers, 0), false, "byp_close_all_buffers", 21, "Reloads buffers", 15, "P:\\4coder\\4coder_byp\\4coder_byp_commands.cpp", 44, 34 },
	{ PROC_LINKS(byp_find_divider_down, 0), false, "byp_find_divider_down", 21, "Find //- divider below cursor", 29, "P:\\4coder\\4coder_byp\\4coder_byp_commands.cpp", 44, 262 },
	{ PROC_LINKS(byp_find_divider_up, 0), false, "byp_find_divider_up", 19, "Find //- divider above cursor", 29, "P:\\4coder\\4coder_byp\\4coder_byp_commands.cpp", 44, 256 },
	{ PROC_LINKS(byp_list_all_locations_selection, 0), false, "byp_list_all_locations_selection", 32, "Lists locations of selection range", 34, "P:\\4coder\\4coder_byp\\4coder_byp_commands.cpp", 44, 288 },
	{ PROC_LINKS(byp_open_current_peek, 0), false, "byp_open_current_peek", 21, "Sets the active view to the current peeked buffer", 49, "P:\\4coder\\4coder_byp\\4coder_byp_commands.cpp", 44, 302 },
	...
	{ PROC_LINKS(byp_reopen_all_buffers, 0), false, "byp_reopen_all_buffers", 22, "Reload current buffer", 21, "P:\\4coder\\4coder_byp\\4coder_byp_commands.cpp", 44, 69 },
	{ PROC_LINKS(byp_reset_face_size, 0), false, "byp_reset_face_size", 19, "Resets face size to default", 27, "P:\\4coder\\4coder_byp\\4coder_byp_commands.cpp", 44, 111 },
	{ PROC_LINKS(byp_space, 0), false, "byp_space", 9, "When column ruler is set, spaces towards that, else just inserts one space", 74, "P:\\4coder\\4coder_byp\\4coder_byp_commands.cpp", 44, 140 },
	...
	{ PROC_LINKS(byp_toggle_set_col_ruler, 0), false, "byp_toggle_set_col_ruler", 24, "Toggles the column ruler. Set to cursor column when on.", 55, "P:\\4coder\\4coder_byp\\4coder_byp_commands.cpp", 44, 126 },
	...
	{ PROC_LINKS(byp_write_text_input, 0), false, "byp_write_text_input", 20, "Inserts whatever text was used to trigger this command.", 55, "P:\\4coder\\4coder_byp\\4coder_byp_commands.cpp", 44, 166 },
	...
	{ PROC_LINKS(explorer, 0), false, "explorer", 8, "Opens file explorer in hot directory", 36, "P:\\4coder\\4coder_byp\\4coder_byp_commands.cpp", 44, 269 },
	...
	{ PROC_LINKS(format_all_buffers, 0), false, "format_all_buffers", 18, "Auto-indent and remove blank lines for all loaded buffers", 57, "P:\\4coder\\4coder_byp\\4coder_byp_commands.cpp", 44, 97 },
	...
	{ PROC_LINKS(zbyp_reload_project, 0), false, "zbyp_reload_project", 19, "Reloads the project.4coder file", 31, "P:\\4coder\\4coder_byp\\4coder_byp_commands.cpp", 44, 55 },
};
