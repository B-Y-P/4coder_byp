...
CUSTOM_COMMAND_MC_COPY_SIG(copy)
...
CUSTOM_COMMAND_MC_COPY_SIG(cut)
...
CUSTOM_COMMAND_MC_PASTE_SIG(paste)
...
CUSTOM_COMMAND_MC_PASTE_SIG(paste_next)
...
CUSTOM_COMMAND_MC_PASTE_SIG(paste_and_indent)
...
CUSTOM_COMMAND_MC_PASTE_SIG(paste_next_and_indent)
...
CUSTOM_COMMAND_MC_COPY_SIG(clear_clipboard)
