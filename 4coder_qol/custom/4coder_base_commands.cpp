...
CUSTOM_COMMAND_MC_CURSOR_SIG(write_space)
CUSTOM_DOC("Inserts a space.")
{
  write_text(app, string_u8_litexpr(" "));
}

CUSTOM_COMMAND_MC_CURSOR_SIG(write_underscore)
CUSTOM_DOC("Inserts an underscore.")
{
  write_text(app, string_u8_litexpr("_"));
}

CUSTOM_COMMAND_MC_CURSOR_SIG(delete_char)
...
CUSTOM_COMMAND_MC_CURSOR_SIG(backspace_char)
...
CUSTOM_COMMAND_MC_CURSOR_SIG(set_mark)
...
CUSTOM_COMMAND_MC_CURSOR_SIG(cursor_mark_swap)
...
CUSTOM_COMMAND_MC_CURSOR_SIG(delete_range)
...
CUSTOM_COMMAND_MC_CURSOR_SIG(backspace_alpha_numeric_boundary)
...
CUSTOM_COMMAND_MC_CURSOR_SIG(delete_alpha_numeric_boundary)
...
CUSTOM_COMMAND_MC_CURSOR_SIG(snipe_backward_whitespace_or_token_boundary)
...
CUSTOM_COMMAND_MC_CURSOR_SIG(snipe_forward_whitespace_or_token_boundary)
...
CUSTOM_COMMAND_MC_GLOBAL_SIG(center_view)
...
CUSTOM_COMMAND_MC_GLOBAL_SIG(left_adjust_view)
...
CUSTOM_COMMAND_MC_CURSOR_SIG(move_left)
...
CUSTOM_COMMAND_MC_CURSOR_SIG(move_right)
...
CUSTOM_COMMAND_MC_CURSOR_SIG(move_right_whitespace_boundary)
...
CUSTOM_COMMAND_MC_CURSOR_SIG(move_left_whitespace_boundary)
...
CUSTOM_COMMAND_MC_CURSOR_SIG(move_right_token_boundary)
...
CUSTOM_COMMAND_MC_CURSOR_SIG(move_left_token_boundary)
...
CUSTOM_COMMAND_MC_CURSOR_SIG(move_right_whitespace_or_token_boundary)
...
CUSTOM_COMMAND_MC_CURSOR_SIG(move_left_whitespace_or_token_boundary)
...
CUSTOM_COMMAND_MC_CURSOR_SIG(move_right_alpha_numeric_boundary)
...
CUSTOM_COMMAND_MC_CURSOR_SIG(move_left_alpha_numeric_boundary)
...
CUSTOM_COMMAND_MC_CURSOR_SIG(move_right_alpha_numeric_or_camel_boundary)
...
CUSTOM_COMMAND_MC_CURSOR_SIG(move_left_alpha_numeric_or_camel_boundary)
...
CUSTOM_COMMAND_MC_CURSOR_SIG(to_uppercase)
...
CUSTOM_COMMAND_MC_CURSOR_SIG(to_lowercase)
...
CUSTOM_COMMAND_MC_GLOBAL_SIG(clean_all_lines)
...
CUSTOM_COMMAND_MC_GLOBAL_SIG(clean_trailing_whitespace)
...
CUSTOM_COMMAND_MC_GLOBAL_SIG(show_scrollbar)
...
CUSTOM_COMMAND_MC_GLOBAL_SIG(hide_scrollbar)
...
CUSTOM_COMMAND_MC_GLOBAL_SIG(show_filebar)
...
CUSTOM_COMMAND_MC_GLOBAL_SIG(hide_filebar)
...
CUSTOM_COMMAND_MC_GLOBAL_SIG(toggle_filebar)
...
CUSTOM_COMMAND_MC_GLOBAL_SIG(toggle_fps_meter)
CUSTOM_DOC("Toggles the visibility of the FPS performance meter")
{
  show_fps_hud = !show_fps_hud;
}

CUSTOM_COMMAND_MC_GLOBAL_SIG(set_face_size)
...
CUSTOM_COMMAND_MC_GLOBAL_SIG(increase_face_size)
...
CUSTOM_COMMAND_MC_GLOBAL_SIG(decrease_face_size)
...
CUSTOM_COMMAND_MC_GLOBAL_SIG(set_face_size_this_buffer)
...
CUSTOM_COMMAND_MC_GLOBAL_SIG(mouse_wheel_change_face_size)
...
CUSTOM_COMMAND_MC_GLOBAL_SIG(toggle_show_whitespace)
...
CUSTOM_COMMAND_MC_GLOBAL_SIG(toggle_line_numbers)
...
CUSTOM_COMMAND_MC_GLOBAL_SIG(toggle_line_wrap)
...
CUSTOM_COMMAND_MC_GLOBAL_SIG(exit_4coder)
...
CUSTOM_COMMAND_MC_CURSOR_SIG(duplicate_line)
...
CUSTOM_COMMAND_MC_CURSOR_SIG(delete_line)
...
CUSTOM_COMMAND_MC_GLOBAL_SIG(swap_panels)
...
CUSTOM_COMMAND_MC_GLOBAL_SIG(save)
