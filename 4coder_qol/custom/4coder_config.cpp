...
function void
def_toggle_config_b32(String_ID key){
  def_set_config_var(key, !def_get_config_b32(key));
}
...
CUSTOM_COMMAND_MC_GLOBAL_SIG(load_theme_current_buffer)
...
CUSTOM_COMMAND_MC_GLOBAL_SIG(go_to_user_directory)
