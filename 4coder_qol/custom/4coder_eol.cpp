...
CUSTOM_COMMAND_MC_GLOBAL_SIG(set_eol_mode_to_crlf)
...
CUSTOM_COMMAND_MC_GLOBAL_SIG(set_eol_mode_to_lf)
...
CUSTOM_COMMAND_MC_GLOBAL_SIG(set_eol_mode_to_binary)
...
CUSTOM_COMMAND_MC_GLOBAL_SIG(set_eol_mode_from_contents)
