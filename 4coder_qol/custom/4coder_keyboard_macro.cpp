...
CUSTOM_COMMAND_MC_GLOBAL_SIG(keyboard_macro_start_recording)
...
CUSTOM_COMMAND_MC_GLOBAL_SIG(keyboard_macro_finish_recording)
...
CUSTOM_COMMAND_MC_CURSOR_SIG(keyboard_macro_replay)
