...
Character_Predicate operator|(Character_Predicate a, Character_Predicate b){ return character_predicate_or (&a, &b); }
Character_Predicate operator&(Character_Predicate a, Character_Predicate b){ return character_predicate_and(&a, &b); }
Character_Predicate operator~(Character_Predicate a                       ){ return character_predicate_not(&a    ); }
