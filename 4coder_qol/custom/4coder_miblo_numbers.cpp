...
CUSTOM_COMMAND_MC_CURSOR_SIG(miblo_increment_basic)
...
CUSTOM_COMMAND_MC_CURSOR_SIG(miblo_decrement_basic)
...
CUSTOM_COMMAND_MC_CURSOR_SIG(miblo_increment_time_stamp)
...
CUSTOM_COMMAND_MC_CURSOR_SIG(miblo_decrement_time_stamp)
CUSTOM_DOC("Decrement a time stamp under the cursor by one second. (format [m]m:ss or h:mm:ss")
{
  miblo_time_stamp_alter(app, MIBLO_SECOND, -1);
}

CUSTOM_COMMAND_MC_CURSOR_SIG(miblo_increment_time_stamp_minute)
...
CUSTOM_COMMAND_MC_CURSOR_SIG(miblo_decrement_time_stamp_minute)
