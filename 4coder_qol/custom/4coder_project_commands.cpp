...
CUSTOM_COMMAND_MC_GLOBAL_SIG(load_project)
...
CUSTOM_COMMAND_MC_GLOBAL_SIG(project_fkey_command)
...
CUSTOM_COMMAND_MC_GLOBAL_SIG(project_go_to_root_directory)
...
CUSTOM_COMMAND_MC_GLOBAL_SIG(project_command_lister)
