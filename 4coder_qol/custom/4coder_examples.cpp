...
CUSTOM_COMMAND_MC_CURSOR_SIG(double_backspace)
CUSTOM_DOC("Example of history group helpers")
{
  /* History_Group is a wrapper around the history API that makes it easy to
      ...
      CUSTOM_COMMAND_MC_GLOBAL_SIG(play_with_a_counter)
      ...
      CUSTOM_COMMAND_MC_GLOBAL_SIG(display_key_codes)
      ...
      CUSTOM_COMMAND_MC_GLOBAL_SIG(display_text_input)
...
CUSTOM_COMMAND_MC_GLOBAL_SIG(music_start)
...
CUSTOM_COMMAND_MC_GLOBAL_SIG(music_stop)
CUSTOM_DOC("Stops the music.")
{
  def_audio_stop(&the_music_control);
}

CUSTOM_COMMAND_MC_GLOBAL_SIG(hit_sfx)
